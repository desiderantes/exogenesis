/* exogenesis.c generated by valac 0.12.1, the Vala compiler
 * generated from exogenesis.vala, do not modify */
...
#define MAIN_UI_FILE "src/exogenesis.ui"
Main* main_new (void);
...
Main* main_construct (GType object_type) {
	...
	_tmp2_ = _tmp1_;
	_tmp3_ = _g_object_ref0 (GTK_IS_WINDOW (_tmp2_) ? ((GtkWindow*) _tmp2_) : NULL);
	window = _tmp3_;
